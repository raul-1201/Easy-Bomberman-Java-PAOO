...
public class Hero extends Character
{
   // private BufferedImage image;    /*!< Referinta catre imaginea curenta a eroului.*/
    ...
    public Hero(RefLinks refLink, float x, float y)
    {
      ...
      //  image = Assets.heroLeft;
        ...
        animDown = new Animation(600, Assets.heroDown);
        animUp = new Animation(600, Assets.heroUp);
        animLeft = new Animation(600, Assets.heroLeft);
        animRight = new Animation(600, Assets.heroRight);
    }
  ...
  /*      if(refLink.GetKeyManager().left == true)
    ...
    public void Draw(Graphics g)
    {
        ...
        Text.drawString(g,"Player 1 ",25,25,false, Color.white, Assets.font25);
        Text.drawString(g,"Bombs " +count1,25,45,false, Color.white, Assets.font25);
