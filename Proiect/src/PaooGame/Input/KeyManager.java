...
public class KeyManager implements KeyListener
{
    ...
    public boolean k;
    public boolean p;
    public boolean up1;      /*!< Flag pentru tasta "sus" apasata.*/
    public boolean down1;    /*!< Flag pentru tasta "jos" apasata.*/
    public boolean left1;    /*!< Flag pentru tasta "stanga" apasata.*/
    public boolean right1;/*!< Flag pentru tasta "dreapta" apasata.*/
